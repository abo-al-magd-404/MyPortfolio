...
//   >
//     <div className="flex items-center text-base md:text-lg">{children}</div>
//   </motion.div>
// );
...
//     <div className={`p-3 rounded-xl bg-gray-800/40 ${color}`}>
//       <FontAwesomeIcon icon={icon} className="text-2xl" />
//     </div>
//     <h2 className={`text-2xl font-black uppercase tracking-widest ${color}`}>
//       {title}
//     </h2>
//   </div>
// );
...
//   return (
//     <section
//       className="min-h-screen py-24 px-6 lg:px-24 bg-transparent"
//       id="education"
//     >
//       {/* Main Title */}
...
//         </h1>
//         <p className="text-gray-500 font-bold uppercase tracking-[0.5em] text-xs mt-4">
//           Academic & Professional History
//         </p>
//       </div>

//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 max-w-7xl mx-auto">
//         {/* LEFT SIDE: Academic Path */}
...
//           <div className="absolute left-7.75 top-32 bottom-0 w-1 bg-linear-to-b from-rose-500/50 via-rose-500/10 to-transparent hidden md:block" />

//           <div className="space-y-4">
//             {/* Header with Date and Improved Spacing */}
//             <div className="flex items-center gap-6 mb-12 ml-2">
//               <span className="text-rose-500 font-black italic text-xl tracking-wider">
//                 2023 - 2027
//               </span>
...
//                 <div className="absolute left-6.75 top-1/2 -translate-y-1/2 w-3 h-3 bg-black border-2 border-rose-500 rounded-full z-20 hidden md:block" />
//                 <TimelineCard borderColor="border-rose-500/40">
//                   <span className="text-rose-500 font-black mr-4 text-xs">
...
//         {/* RIGHT SIDE: Courses & Certificates */}
//         <div className="space-y-16 order-2 lg:order-2">
//           {/* Expertise Courses */}
//           <div className="space-y-6">
//             <SectionHeader
//               title="Expertise Courses"
...
//                     </h3>
//                     <span
//                       className={`text-[9px] px-2 py-1 rounded font-semibold uppercase ${
...
//             />
//             <div className="bg-gray-800/5 border border-gray-800/50 p-5 rounded-[2.5rem] w-full mx-auto lg:mx-0">
//               <div
//                 className="relative w-full aspect-video rounded-xl overflow-hidden border border-gray-700 shadow-xl group cursor-pointer"
//                 onClick={() => setSelectedCert(CERTIFICATES[certIndex])}
//               >
//                 <Image
//                   src={CERTIFICATES[certIndex].file}
//                   alt={CERTIFICATES[certIndex].name}
//                   fill
//                   className="object-cover transition-transform duration-500 group-hover:scale-105"
//                 />
//               </div>
//               <div className="mt-5">
//                 <h3 className="text-lg font-black text-white truncate px-2">
...
//                       )
//                     }
//                     className="text-emerald-400 hover:scale-125 transition-transform"
//                   >
//                     <FontAwesomeIcon icon={faChevronLeft} />
//                   </button>
//                   <button
//                     onClick={() => setSelectedCert(CERTIFICATES[certIndex])}
//                     className="px-6 py-2 bg-emerald-600 text-white font-black rounded-full text-[10px] uppercase tracking-widest hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-600/20"
//                   >
//                     Expand
//                   </button>
//                   <button
...
//           {/* Quote Section */}
//           <motion.div className="p-10 border border-gray-800 rounded-[2.5rem] bg-gray-900/5 relative overflow-hidden group">
//             <FontAwesomeIcon
//               icon={faGraduationCap}
//               className="absolute -top-6 -right-6 text-9xl text-white/5 group-hover:text-white/10 transition-all duration-1000"
//             />
//             <p className="text-2xl md:text-3xl font-black italic text-transparent bg-clip-text bg-linear-to-r from-sky-400 via-emerald-400 to-rose-400 leading-tight relative z-10">
...
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
//             className="fixed inset-0 bg-black/98 backdrop-blur-md z-200 flex items-center justify-center p-4 shadow-2xl"
//           >
//             <div className="relative w-full max-w-4xl text-center flex flex-col items-center">
//               <button
//                 onClick={() => setSelectedCert(null)}
//                 className="absolute -top-14 right-0 text-white text-4xl hover:text-rose-500 transition-colors"
//               >
//                 <FontAwesomeIcon icon={faTimes} />
//               </button>
//               <div className="relative w-full h-[60vh] rounded-2xl overflow-hidden border border-white/5 bg-gray-900 shadow-lg">
//                 <Image
...
//                 />
//               </div>
//               <div className="mt-8 flex flex-col justify-between items-center gap-4 px-4 w-full">
...
//                   download
//                   className="bg-white text-black px-8 py-3 rounded-full font-black uppercase text-xs tracking-widest hover:bg-emerald-500 hover:text-white transition-all flex items-center gap-3"
//                 >
